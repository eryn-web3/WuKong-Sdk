...
(function (ChainId) {
  ...
  ChainId[ChainId["FANTOMNET"] = 250] = "FANTOMNET";
  ChainId[ChainId["FANTOMTESTNET"] = 4002] = "FANTOMTESTNET";
  ChainId[ChainId["HARMONYNET"] = 1666600000] = "HARMONYNET";
...
Currency.ETHER = {
  1: /*#__PURE__*/new Currency(18, 'ETH', 'Ethereum'),
  4: /*#__PURE__*/new Currency(18, 'ETH', 'Ethereum'),
  56: /*#__PURE__*/new Currency(18, 'BNB', 'Binance'),
  97: /*#__PURE__*/new Currency(18, 'BNB', 'Binance'),
  250: /*#__PURE__*/new Currency(18, 'FTM', 'Fantom'),
  4002: /*#__PURE__*/new Currency(18, 'FTM', 'Fantom'),
  1666600000: /*#__PURE__*/new Currency(18, 'ONE', 'Harmony'),
  1666700000: /*#__PURE__*/new Currency(18, 'ONE', 'Harmony')
};
...
var WETH = (_WETH = {}, _WETH[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', 18, 'WETH', 'Wrapped ETH'), _WETH[exports.ChainId.RINKEBY] = /*#__PURE__*/new Token(exports.ChainId.RINKEBY, '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', 18, 'WETH', 'Wrapped ETH'), _WETH[exports.ChainId.BSCNET] = /*#__PURE__*/new Token(exports.ChainId.BSCNET, '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', 18, 'WBNB', 'Wrapped BNB'), _WETH[exports.ChainId.BSCTESTNET] = /*#__PURE__*/new Token(exports.ChainId.BSCTESTNET, '0xaE8E19eFB41e7b96815649A6a60785e1fbA84C1e', 18, 'WBNB', 'Wrapped BNB'), _WETH[exports.ChainId.FANTOMNET] = /*#__PURE__*/new Token(exports.ChainId.FANTOMNET, '0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83', 18, 'wFTM', 'Wrapped Fantom'), _WETH[exports.ChainId.FANTOMTESTNET] = /*#__PURE__*/new Token(exports.ChainId.FANTOMTESTNET, '0xf1277d1ed8ad466beddf92ef448a132661956621', 18, 'wFTM', 'Wrapped Fantom'), _WETH[exports.ChainId.HARMONYNET] = /*#__PURE__*/new Token(exports.ChainId.HARMONYNET, '0xcf664087a5bb0237a0bad6742852ec6c8d69a27a', 18, 'WONE', 'Wrapped ONE'), _WETH[exports.ChainId.HARMONYTESTNET] = /*#__PURE__*/new Token(exports.ChainId.HARMONYTESTNET, '0xcf664087a5bb0237a0bad6742852ec6c8d69a27a', 18, 'WONE', 'Wrapped ONE'), _WETH);
...
var Price = /*#__PURE__*/function (_Fraction) {
  ...
  function Price(baseCurrency, quoteCurrency, denominator, numerator, chainId) {
    var _this;
  ...
  Price.fromRoute = function fromRoute(route) {
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(route.pairs.entries()), _step; !(_step = _iterator()).done;) {
      var _step$value = _step.value,
          i = _step$value[0],
          pair = _step$value[1];
      prices.push(route.path[i].equals(pair.token0) ? new Price(pair.reserve0.currency, pair.reserve1.currency, pair.reserve0.raw, pair.reserve1.raw, pair.token0.chainId) : new Price(pair.reserve1.currency, pair.reserve0.currency, pair.reserve1.raw, pair.reserve0.raw, pair.token0.chainId));
    }
  ...
  _proto.multiply = function multiply(other) {
    ...
    return new Price(this.baseCurrency, other.quoteCurrency, fraction.denominator, fraction.numerator, other.chainId);
  ...
  _proto.quote = function quote(currencyAmount) {
    ...
    return CurrencyAmount.ether(_Fraction.prototype.multiply.call(this, currencyAmount.raw).quotient, this.chainId);
  };
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'Wukong-LP', 'Wukong LPs');
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === ETHER[pairs[0].chainId] && pairs[0].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === ETHER[pairs[0].chainId] && pairs[pairs.length - 1].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input === ETHER[route.chainId] ? CurrencyAmount.ether(amounts[0].raw, route.chainId) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output === ETHER[route.chainId] ? CurrencyAmount.ether(amounts[amounts.length - 1].raw, route.chainId) : amounts[amounts.length - 1];
    this.executionPrice = new Price(this.inputAmount.currency, this.outputAmount.currency, this.inputAmount.raw, this.outputAmount.raw, route.chainId);
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    var etherIn = trade.inputAmount.currency === ETHER[trade.route.chainId];
    var etherOut = trade.outputAmount.currency === ETHER[trade.route.chainId]; // the router does not support both ether in and out
...
var TOKEN_DECIMALS_CACHE = (_TOKEN_DECIMALS_CACHE = {}, _TOKEN_DECIMALS_CACHE[exports.ChainId.BSCNET] = {
